  ...
  render(){
    ...
    return (
      <div>
        ...
        {/* About me */}
        <Main>
          <About id="about" imageUrl={process.env.PUBLIC_URL + '/assets/profile_img.webp'} imageUrl2={process.env.PUBLIC_URL + '/assets/profile_img_desktop.webp'}>
                ...
                <Blocks style={{height: '56px'}}>
                  <FloatingBlock time="2.5">
                    <Highlight>
                      <TypeAnimation
                        cursor={false}
                        sequence={['BackEnd', 1500, 'FrontEnd', 1500, 'Mobile', 1500]}
                        wrapper="span"
                        repeat={Infinity}
                      />|
                    </Highlight>
